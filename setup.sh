...
echo "I would recommend that you restart your terminal window for the docker configurations to take effect, even restarting the Pi5 is probably worth it!"
